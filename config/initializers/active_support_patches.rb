module ActiveSupport
  ...
  class BufferedLogger
    ...
    NUMBER_TO_COLOR_MAP = {0=>'0;36', 1=>'32', 2=>'33', 3=>'31', 4=>'31', 5=>'36'}
    ...
    def add(severity, message = nil, progname = nil, &block)
      ...
      message = "\033[0;36m#{Time.now.to_s(:db)}\033[0m [\033[#{color}m" + sprintf("%-5s", "#{sevstring}") + "\033[0m] #{message.strip} (pid:#{$$})\n" unless message[-1] == ?\n
      buffer << message
      auto_flush
      message
    end
